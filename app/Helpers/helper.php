    ...
    function settings($user_id = null)
    {
        ...
        if (is_null($user_id)) {
            if (auth()->user()) {
                ...
                $user = User::where('type', 'superadmin')->first() ?? User::where('type', 'company')->first();
        ...
        if (auth()->check() && auth()->user()->type !== 'superadmin') {
            $superAdmin = User::where('type', 'superadmin')->first() ?? User::where('type', 'company')->first();
            if ($superAdmin) {
...
if (! function_exists('getPaymentGatewaySettings')) {
    ...
    {
        $superAdminId = (User::where('type', 'superadmin')->first() ?? User::where('type', 'company')->first())?->id;
